      ...
      <Row>
        <Col sm={6}>
          ...
          <p>
            ...
            cards to simple websites to complex custom web applications, we got
            you! With over 15 years of experience developing custom,
            high-traffic web applications- we have got you covered. We look
            forward to working with you!
          </p>
          <p>
            Check us out-{" "}
            <a href="http://www.atozionwebdesign.com">
              A To Zion Web Design, LLC
            </a>
          </p>
